# coding=utf-8
# Adapted from
# https://huggingface.co/xverse/XVERSE-13B/blob/main/modeling_xverse.py
...
from vllm.transformers_utils.configs import XverseConfig
...
class XverseForCausalLM(nn.Module):
    ...
    def load_weights(self,
        ...
        attention_weight_specs = [
            ...
            ("k_proj", q_proj_shard_size, q_proj_shard_size),
            ("v_proj", q_proj_shard_size, 2 * q_proj_shard_size),
        ]
